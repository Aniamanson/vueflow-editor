...
<template>
  ...
  <svg v-if="props.name === 'reset'" width="16" height="16" viewBox="0 0 32 32">
    <path d="M18 28A12 12 0 1 0 6 16v6.2l-3.6-3.6L1 20l6 6l6-6l-1.4-1.4L8 22.2V16a10 10 0 1 1 10 10Z" />
  </svg>

  <svg v-if="props.name === 'update'" width="16" height="16" viewBox="0 0 24 24">
    <path
  ...
  <svg v-if="props.name === 'sun'" width="16" height="16" viewBox="0 0 24 24">
    <path
  ...
  <svg v-if="props.name === 'moon'" width="16" height="16" viewBox="0 0 24 24">
    <path
  ...
  <svg v-if="props.name === 'log'" width="16" height="16" viewBox="0 0 24 24">
    <path
